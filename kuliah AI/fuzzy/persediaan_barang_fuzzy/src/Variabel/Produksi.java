...
public class Produksi {
    ...
    private static final double titik2=2000;
    private static final double titik3=7000;

    //buat method untuk mengakses nilai pada variabel produksi
    public static double getProduksi() { return produksi; }
    //buat method untuk memberikan nilai pada variabel produksi
    public static void setProduksi(double produksi) { Produksi.produksi = produksi; }
    ...
    public static double berkurang(double in){ return (titik3-(in*(titik3-titik2))); }
    public static double bertambah(double in){ return (titik2+(in*(titik3-titik2))); }
}
